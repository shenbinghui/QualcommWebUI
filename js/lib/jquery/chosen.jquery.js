      ...
      if (this.result_highlight) {
        ...
        return this.search_field_scale();
          ...
          for(var i = 0; i < this.form_field.options.length; i++){
              if(this.form_field.options[i].value == getLastNumber(searchVal,11)){
          ...
          if(!isExist){
              if (this.max_selected_options >= this.choices){
                  this.form_field.add(new Option(searchVal, getLastNumber(searchVal,11), false, true));
              } else {
                  this.form_field.add(new Option(searchVal, getLastNumber(searchVal,11), false, false));
              }
          }
